...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        colories_per_minute = (self.COEFF3 * speed - self.COEFF4) * self.weight
        training_mins = self.duration * self.CONVERTER
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        сount_calories = ((self.COEFF_CALORIES_1 * self.weight
...
class Swimming(Training):
    ...
    def get_mean_speed(self) -> float:
        """Получить среднюю скорость движения."""
        mean_spd = (self.lenght_pool * self.count_pool
                   / self.M_IN_KM / self.duration)
        return mean_spd

    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        сount_calories = ((self.get_mean_speed() + self.COEFF1)
